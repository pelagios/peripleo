  ...
  var ObjectLayer = function(map, eventBroker) {
    ...
    var self = this,
        ...
        selectObjects = function(objects) {
          var geomHash, tuple, marker, center, pin, removeOnDeselect = false;
          ...
          if (objects) {
            ...
            currentSelection =
              { marker: marker, pin: pin, objects: objects, removeOnDeselect: removeOnDeselect };
        ...
        clearSelection = function() {
          if (currentSelection) {
            ...
            if (currentSelection.removeOnDeselect)
              map.removeLayer(currentSelection.marker);
